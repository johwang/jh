...
<nav class="navbar navbar-expand navbar-dark bg-dark">
	<div class="container">
		...
		<ul class="navbar-nav mr-auto">
			...
			<a class="navbar-brand"
				href="${pageContext.request.contextPath}/products.jsp">상품목록</a>
			<a class="navbar-brand"
				href="${pageContext.request.contextPath}/addProduct.jsp">상품등록</a>
			<a class="navbar-brand"
				href="${pageContext.request.contextPath}/editProduct.jsp?edit=update">수정</a>
			<a class="navbar-brand"
				href="${pageContext.request.contextPath}/editProduct.jsp?edit=delete">삭제</a>
			<a class="navbar-brand"
				href="${pageContext.request.contextPath}/addCategory.jsp">카테고리등록</a>
		</ul>
	</div>
</nav>